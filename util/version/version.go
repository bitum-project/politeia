...
// Copyright (c) 2015-2018 The Bitum developers
// Use of this source code is governed by an ISC
// license that can be found in the LICENSE file.

// Package version provides a single location to house the version information
// for bitumd and other utilities provided in the same repository.
package version
...
var (
	...
	// build process with:
	// '-ldflags "-X github.com/bitum-project/politeia/util/version.PreRelease=foo"'
	...
	// build process with:
	// '-ldflags "-X github.com/bitum-project/politeia/util/version.BuildMetadata=foo"'
