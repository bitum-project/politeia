...
// merkle root, that get checkpointed in bitumtime. This provides censorship
...
// have not been checkpointed in bitumtime yet. To identify these, we parse the
...
// LastAnchor stores the last commit anchored in bitumtime.
