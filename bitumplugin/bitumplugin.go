...
// NewCommentReply returns the metadata generated by bitum plugin for the new
// comment.
...
// Inventory is used to retrieve the bitum plugin inventory.
...
// InventoryReply returns the bitum plugin inventory.
