# Politeia
[![Build Status](https://img.shields.io/travis/bitum/politeia.svg)](https://travis-ci.org/bitum/politeia)
[![ISC License](https://img.shields.io/badge/license-ISC-blue.svg)](http://copyfree.org)

**Politeia is the Bitum proposal system.**
...
timestamping”. Instead of attempting to store all the data related to Bitum’s
governance on-chain, we have opted to create an off-chain store of data that is
anchored into Bitum’s blockchain, minimizing its on-chain footprint.
...
* [politeia](https://github.com/bitum-project/politeia/tree/master/politeiad/cmd/politeia) - Reference client application for politeiad.
* [politeia_verify](https://github.com/bitum-project/politeia/tree/master/politeiad/cmd/politeia_verify) - Reference verification tool.
* [politeiawwwcli](https://github.com/bitum-project/politeia/tree/master/politeiawww/cmd/politeiawwwcli) - Command-line tool for interacting with politeiawww.
* [politeiawww_dbutil](https://github.com/bitum-project/politeia/tree/master/politeiawww/cmd/politeiawww_dbutil) - Tool for debugging and creating admin users within the politeiawww database.
* [politeiawww_dataload](https://github.com/bitum-project/politeia/tree/master/politeiawww/cmd/politeiawww_dataload) - Tool using politeiawwwcli to load a basic dataset into politeiawww.
...
https://github.com/bitum-project/politeiagui
...
Copy and change the [`sample-politeiawww.conf`](https://github.com/bitum-project/politeia/blob/master/politeiawww/sample-politeiawww.conf)
and [`sample-politeiad.conf`](https://github.com/bitum-project/politeia/blob/master/politeiad/sample-politeiad.conf) files.
...
to github and cryptographically timestamped onto the Bitum blockchain.  The
...
* Follow the instructions at [bitum/politeiagui](https://github.com/bitum-project/politeiagui)
to setup Politeia and access it through the UI.
* Use the [politeiawwwcli](https://github.com/bitum-project/politeia/tree/master/politeiawww/cmd/politeiawwwcli) tool to interact with politeiawww.
* Use the [politeia](https://github.com/bitum-project/politeia/tree/master/politeiad/cmd/politeia) tool to interact directly with politeiad.
...
[politeiawww_dbutil](https://github.com/bitum-project/politeia/tree/master/politeiawww/cmd/politeiawww_dbutil).

#### Paywall

This politeiawww feature prevents users from submitting new proposals and
comments until a payment in BITUM has been paid. By default, it needs a
...
keys (see [`sample-politeiawww.conf`](https://github.com/bitum-project/politeia/blob/master/politeiawww/sample-politeiawww.conf))
...
```
bitumctl --wallet --testnet createnewaccount politeiapayments
bitumctl --wallet --testnet getmasterpubkey politeiapayments
```
...
* https://faucet.bitum.io - instance of [testnetfaucet](https://github.com/bitum-project/testnetfaucet)
  which is used by **politeiawww_refclient** to satisfy paywall requests in an
  automated fashion.

* https://test-proposals.bitum.io/ - testing/development instance of Politeia.

* https://pi-staging.bitum.io/ - politeia staging environment.

* https://proposals.bitum.io/ - live production instance of Politeia.
